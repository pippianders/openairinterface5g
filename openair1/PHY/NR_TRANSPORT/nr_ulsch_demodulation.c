...
void nr_ulsch_channel_compensation(int **rxdataF_ext,
  ...
  unsigned short rb;
  unsigned char aatx,aarx;
  simde__m128i *ul_ch128,*ul_ch128_2,*ul_ch_mag128,*ul_ch_mag128b,*rxdataF128,*rxdataF_comp128,*rho128;
    ...
    for (aarx=0; aarx<frame_parms->nb_antennas_rx; aarx++)  {
      ...
      for (rb=0; rb<nb_rb_0; rb++) {
        if (mod_order>2) {
          ...
          ul_ch_mag128[0] = simde_mm_mulhi_epi16(ul_ch_mag128[0],QAM_amp128);
          ul_ch_mag128[0] = simde_mm_slli_epi16(ul_ch_mag128[0],1);

          ul_ch_mag128b[0] = simde_mm_mulhi_epi16(ul_ch_mag128b[0],QAM_amp128b);
          ul_ch_mag128b[0] = simde_mm_slli_epi16(ul_ch_mag128b[0],1);
          ...
          ul_ch_mag128[1] = simde_mm_mulhi_epi16(ul_ch_mag128[1],QAM_amp128);
          ul_ch_mag128[1] = simde_mm_slli_epi16(ul_ch_mag128[1],1);
          
          ul_ch_mag128b[1] = simde_mm_mulhi_epi16(ul_ch_mag128b[1],QAM_amp128b);
          ul_ch_mag128b[1] = simde_mm_slli_epi16(ul_ch_mag128b[1],1);
          ...
          ul_ch_mag128[2] = simde_mm_mulhi_epi16(ul_ch_mag128[2],QAM_amp128);
          ul_ch_mag128[2] = simde_mm_slli_epi16(ul_ch_mag128[2],1);


          ul_ch_mag128b[2] = simde_mm_mulhi_epi16(ul_ch_mag128b[2],QAM_amp128b);
          ul_ch_mag128b[2] = simde_mm_slli_epi16(ul_ch_mag128b[2],1);
...
void nr_ulsch_detection_mrc(NR_DL_FRAME_PARMS *frame_parms,
  ...
  simde__m128i *rxdataF_comp128[2],*ul_ch_mag128[2],*ul_ch_mag128b[2];
  int32_t i;
  uint32_t nb_rb_0 = length/12 + ((length%12)?1:0);
    ...
    for (int aatx=0; aatx<nrOfLayers; aatx++) {
      ...
      for (int aa=1;aa < n_rx;aa++) {
        ...
        for (i=0; i<nb_rb_0*3; i++) {
            ...
            //rxdataF_comp128[0][i] = simde_mm_add_epi16(rxdataF_comp128_0[i],(*(simde__m128i *)&jitterc[0]));
        }
      }
    }
  }
