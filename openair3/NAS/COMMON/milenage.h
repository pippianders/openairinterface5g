...
static bool milenage_f1(const uint8_t *opc, const uint8_t *k, const uint8_t *_rand,
...
/**
   ...
   Returns: true on success, false on failure
*/
static bool milenage_f2345(const uint8_t *opc, const uint8_t *k, const uint8_t *_rand,
...
*/
static bool milenage_generate(const uint8_t *opc, const uint8_t *amf, const uint8_t *k,
                       const uint8_t *sqn, const uint8_t *_rand, uint8_t *autn, uint8_t *ik,
                       uint8_t *ck, uint8_t *res) {
  int i;
