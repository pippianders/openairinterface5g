...
#define CMDLINE_NRUEPARAMS_DESC {  \
    ...
    {"max-ldpc-iterations",      CONFIG_HLP_MAX_LDPC_ITERATIONS, 0,       iptr:&nrUE_params.max_ldpc_iterations,    defuintval:5,       TYPE_INT, 0}, \
    ...
    {"ue-nb-ant-rx",             CONFIG_HLP_UENANTR,     0,               iptr:&(nrUE_params.nb_antennas_rx),        defuintval:1,          TYPE_INT, 0}, \
    {"ue-nb-ant-tx",             CONFIG_HLP_UENANTT,     0,               iptr:&(nrUE_params.nb_antennas_tx),        defuintval:1,          TYPE_INT, 0}, \
    ...
    {"E" ,                       CONFIG_HLP_TQFS,        PARAMFLAG_BOOL,  iptr:&(nrUE_params.threequarter_fs),       defintval:0,           TYPE_INT, 0}, \
    {"r"  ,                      CONFIG_HLP_PRB_SA,      0,               iptr:&(nrUE_params.N_RB_DL),                defintval:106,         TYPE_INT,  0}, \
    {"ssb",                      CONFIG_HLP_SSC,         0,               iptr:&(nrUE_params.ssb_start_subcarrier), defintval:516,         TYPE_INT,0}, \
